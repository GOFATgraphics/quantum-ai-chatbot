        ...
        <motion.div
          animate={{
            boxShadow: focused || listening
              ? dark
                ? '0 0 0 1px rgba(255,255,255,0.18), 0 8px 28px -6px rgba(0,0,0,0.45)'
                : '0 0 0 1px rgba(0,0,0,0.12), 0 8px 28px -6px rgba(0,0,0,0.12)'
        ...
        >
          ...
          <AnimatePresence>
            {(listening || dictating) && (
              ...
              >
                <div className={`flex flex-col items-center gap-1.5 mb-2 px-2 py-2 rounded-2xl ${
          ...
          <div className="flex items-end gap-2">
            <div className="flex-1 min-w-0 flex flex-col">
              ...
              <div className="flex items-center gap-1.5 pt-1">
                ...
                >
                  {listening && (
                    <span className={`absolute inset-0 rounded-full animate-ping opacity-30 ${dark ? 'bg-white' : 'bg-slate-900'}`} aria-hidden />
                  )}
                  {dictating ? (
