...
export default function Sidebar({
  ...
  // Quantum indigo active state (replaces previous Google-blue accent)
  const active = dark
            ...
            {projects.map((p, i) => (
              ...
              >
                ...
                <button
                  ...
                  className="opacity-70 sm:opacity-0 sm:group-hover:opacity-100 p-2 min-w-[36px] min-h-[36px] flex items-center justify-center text-slate-400 hover:text-red-500 active:text-red-500"
