...
const DRIVE_TOOL = {
  name: 'search_drive',
  description:
    'Search Google Drive for files by name or content. Use when the user asks about files, documents, PDFs, or folders in Drive.',
  input_schema: {
    type: 'object',
    properties: {
      query: {
...
## Formatting
Clean Markdown only. ## / ### headings, short paragraphs, bullets, **bold** labels. No raw JSON dumps.

## Drafting email
Always available: output **To** / **Subject** / **Body** ready to copy. You cannot send email.
